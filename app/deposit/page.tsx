...
function DepositContent() {
  ...
  const [fundOpen, setFundOpen] = useState(defaultTab === "deposit");
  ...
  return (
    <PageWrapper>
      <div className="px-4 pt-4 pb-2">
        ...
        <BalanceWidget onDeposit={() => setFundOpen(true)} />
      </div>
      ...
      <div className="px-4 mt-4 p-4 bg-bg-surface border border-border rounded-2xl mx-4">
        ...
        <ol className="flex flex-col gap-2 text-xs text-text-secondary list-decimal list-inside">
          <li>Choose a network and copy your deposit address</li>
          <li>Send USDT or USDC from any wallet or exchange</li>
